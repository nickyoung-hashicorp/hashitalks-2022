...
tput setaf 3; echo "CONFIGURING KEY-VALUE SECRETS ENGINE"
tput setaf 3; echo "===================================="
sleep 1
...
tput setaf 3; echo "CONFIGURING TRANSIT SECRETS ENGINE"
tput setaf 3; echo "=================================="
sleep 1
...
tput setaf 3; echo "CONFIGURING PKI SECRETS ENGINE"
tput setaf 3; echo "=============================="
sleep 1
...
tput setaf 3; echo "CONFIGURING DATABASE SECRETS ENGINE"
tput setaf 3; echo "==================================="
sleep 1
...
vault write database/roles/hashitalks-role \
    ...
    default_ttl="8h" \
    max_ttl="24h"
tput setaf 3; echo "GENERATE MYSQL DATABASE CREDENTIALS AND STORE LEASE ID"
tput setaf 3; echo "======================================================"
sleep 1
vault read database/creds/hashitalks-role -format=json | jq -r '.lease_id' > lease_id.txt
sleep 1
tput setaf 3; echo "Lease ID = $(cat lease_id.txt)"
sleep 1

tput setaf 3; echo "CREATE VAULT POLICY"
tput setaf 3; echo "==================="
sleep 1
...
EOF
sleep 1
tput setaf 3; echo "CREAT USERPASS AUTH METHOD WITH \"hashitalks-policy\""
tput setaf 3; echo "====================================================="
sleep 1
...
sleep 1
tput setaf 3; echo "LOGIN WITH USERPASS AUTH METHOD"
tput setaf 3; echo "==============================="
sleep 1
vault login -method=userpass \
    ...
    password=hashitalks
sleep 1
tput setaf 3; echo "TEST SUCCESSFUL KV GET"
tput setaf 3; echo "======================"
sleep 1
vault kv get kv/hashitalks-secret
sleep 1
tput setaf 3; echo "TEST FAILING KV GET"
tput setaf 3; echo "==================="
sleep 1
